...
class _TranwithdrawState extends State<Tranwithdraw> {
  ...
  Future<void> _cancelTransaction(
    ...
    try {
      ...
      final accountDetails = await TransactionService.getWithdrawByAccountNo(
        accountNo,
      );
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              Text(
                'คุณต้องการยกเลิกรายการถอนเงินนี้หรือไม่?',
                style: TextStyle(
                  fontSize: 16,
  ...
  Widget build(BuildContext context) {
    if (loading) {
      return const BeautifulLoading(message: 'กำลังโหลดรายการถอนเงิน');
    }
