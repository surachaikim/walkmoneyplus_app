  ...
  Future<void> setAppLogo() async {
    try {
      ByteData data = await rootBundle.load(
          'assets/Logo.png.png'); // you can set assets path at pubspec.yaml
      bytesAppPhoto =
 ...
 Future<void> textspit() async {
  ...
  var rsu = textResult.split('#');
   ...
   setState(() {
        ...
        birthday.text =rsu[18].trim();
        addno.text=rsu[9].trim();
        moo.text=rsu[10].trim();
        locality.text=rsu[14].trim();
        district.text=rsu[15].trim();
        province.text=rsu[16].trim();
   });
}
          ...
          child:SingleChildScrollView(
            ...
            children: [
               Align(
                  ...
                  child: Image.memory(bytesPhoto ,width: 120, height: 150) ,
                ),
